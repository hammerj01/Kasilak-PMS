...
namespace ParishDataManagement
{
    public partial class frmMarriageEntry : Form
    {
        ...
        private void lstWifeInfo_DoubleClick(object sender, EventArgs e)
        {
            ...
            String strFather = newWifeInfo.GetPersonNameByID(newParent.GetPersonIDByParentsID(newWifeBaptismalInfo.ParentsNoForFather));
            if (!String.IsNullOrEmpty(strFather))
            {
            ...
            String strMother = newWifeInfo.GetPersonNameByID(newParent.GetPersonIDByParentsID(newWifeBaptismalInfo.ParentsNoForMother));
            if (!String.IsNullOrEmpty(strMother))
            {
        ...
        private void cmdAddSponsor_Click(object sender, EventArgs e)
        {
            ...
            newForm.SetSponsorType("Marriage");
            this.SendToBack();
            newForm.ShowDialog();
        }
        ...
        {
            this.SetDataToLicense();
            newLicense.AddNew(newLicense);
            ...
            currSeriesNumber.Update(currSeriesNumber, "MarriageSeries", currSeriesNumber.MarriageSeries);
        ...
        private void SetDataToMarriage() 
        {
            ...
            newMarriage.LicenseNo = txtLicenseNo.Text;
        ...
        private void SetDataToLicense() 
        {
            newLicense.LicenseNo = txtLicenseNo.Text;
            newLicense.Address = txtAddress.Text;
            newLicense.Date = dtLicenseDate.Text;
            newLicense.ObsDate = dtObsDate.Text;
            newLicense.ObsPlace = txtObsPlace.Text;
            newLicense.Observation = txtObservation.Text;
        }
    }
}
